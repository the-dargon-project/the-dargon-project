...
namespace dargon { namespace IO { namespace DIM {
   ...
   public:
      DSPExRITDIMProcessTaskListHandler(UINT32 transactionId, CommandManager* owner) : DSPExRITDIMProcessTaskListHandler(transactionId, owner, nullptr) { }
      DSPExRITDIMProcessTaskListHandler(UINT32 transactionId, CommandManager* owner, dargon::IO::DSP::DSPExLITransactionHandler* completeOnCompletion);
