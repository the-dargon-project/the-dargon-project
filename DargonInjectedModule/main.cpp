...
int main(int argc, wchar_t* argv[]) {
   file_logger::initialize("C:/dim_command_line.log");
   auto logger = file_logger::instance();
   ...
   auto sector_factory = std::make_shared<vfm_sector_factory>(bootstrap_context->io_proxy);
   ...
   Subsystem::Initialize(bootstrap_context, configuration, logger);
