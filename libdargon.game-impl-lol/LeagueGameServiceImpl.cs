...
//         var modification = modificationLoader.EnumerateModifications().First();
//         var chain = new CompletionChain(cancellationToken => leagueBuildUtilities.ResolveModification(modification, cancellationToken));
//         for (var i = 0; i < 6; i++) {
//            var link = chain.CreateLink("link" + i);
//            chain.StartNext(link);
//         }
      }
