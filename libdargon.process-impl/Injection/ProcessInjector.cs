...
namespace Dargon.Processes.Injection
{
   ...
   public class ProcessInjector : IProcessInjector
   {
      ...
      public void InjectToVictim(int processId, string dllPath)
      {
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Open Process Handle for processId " + processId + " to inject dll " + dllPath);
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Allocate Memory in Process");
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Write DLL Path in Process");
         int bytesWritten;
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Get Kernel32.dll Module Handle within process");
         ...
         // Get LoadLibraryA
         //----------------------------------------------------------------------------------------
         logger.Info("Get PFunctionLoadLibraryA Procedure Address within Kernel32.dll Module");
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Create Remote Thread");
         ...
         for (int i = 0; i < 10 && hRemoteThread == IntPtr.Zero; i++)
         {
            ...
            {
               //Win32 Exception
               logger.Info("Win32 Exception when creating remote thread... " + ((i < 9) ? " Trying again" : ""));
               remoteThreadId = 0;
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Wait for Remote Thread Completion");
         ...
         //----------------------------------------------------------------------------------------
         logger.Info("Free Remote Virtual Memory");
